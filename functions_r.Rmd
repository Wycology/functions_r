...
Virtually every time one uses `R`, a function is involved. It is not enough to use a function, it is enou to understand what the function does and even better still to tweak the function to suit your needs or even develop your own function(s).
