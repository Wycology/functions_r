...
There is the `...` variable in `R` tha can be used in a function. It is normally applicable when calling a function within a function and you wish to use all functions from the other function.
