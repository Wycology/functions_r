...
```
It is als possible just to give few unique initials of the name of the argument and the function will run successfully. For example, in our `rescale` function, the arguments start with x and o, so only stating the first name character is enough as follows:
