...
Virtually every time one uses `R`, a function  i used. It is not enough to use a function, it is enough to understand what the function does and even better still to tweak the function to suit your needs or even develop your own function(s).
