...
```
The parameter `...` takes any named parameter at al. However, if it is not included in a function, then you are only limited to arguments in the function and cannot add anything else like `na.rm = T`.
