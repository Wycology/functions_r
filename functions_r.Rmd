...
Virtua very time one uses `R`, a function *must* be used. It is not enough to use a function, it is enough to understand what the function does and even better still tweak it to suit your needs or even develop your own function(s).
