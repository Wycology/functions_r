...
It is al possible to give a function default parameter when defining it. This can be changed by the user when giving appropriate parameter to the argument to show results otherwise.
