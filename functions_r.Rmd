...
Here we are go to create a function that will take a vector, calculate mean, calculate standard deviation, then divide deviations of values from mean by standard deviation
