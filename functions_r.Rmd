...
One can decide and say that if `r 3 + 4` out of the 13 models successfully run are showing suitability of 0.7 then the pixel is considered suitable and not otherwise.
