...
One can decide and say that if `r 3 + 4` out of the `r sqrt(169)` models successfully run are showing suitability of `r 1 - 0.3`0.7 then the pixel is considered suitable and not otherwise.
