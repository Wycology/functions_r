...
This function will create a binary raster layer which is having values of 1 in case the at least 7 of the feeding rasters from the stack have pixel value of not less than 0.5.
