...
Here we wil to create a function that will take a vector, calculate the mean, calculate standard deviation, then divide deviations of values from mean by standard deviation
