...
Every time one use `R`, a function *must* be involved. It is not enough to use a function, it is enough to understand what the function does and even better still tweak it to suit your needs or even develop your own function.
